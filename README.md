...
To launch this service locally via command line run `mvn spring-boot:run`, then connect to `localhost:9000`
...
- Run: `docker run -p 9000:9000 registry.prod.auction.local:5000/homes-ms-retail:DEV`
...
- Run: `docker run -p 9000:9000 registry.prod.auction.local:5000/homes-ms-retail`
